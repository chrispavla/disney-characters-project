    ...
    <div className="card-group col-sm-3">
      <div className="card listcard my-3 mx-4">
        ...
        <div class="card-footer">
          <button
            className="btn btn-primary btn-sm btn-block my-1 mx-1"
            onClick={handleLikes}
          >
            ❤️ {character.likes} Likes{" "}
          </button>
          <button
            className="btn btn-primary btn-sm btn-block my-1 mx-1 favoritesBtn"
            onClick={() => {
